...
<a class="corealm-map-marker" href="../../regions/#the-broken-milestone" style="--map-x:38.3333%;--map-y:49.1667%" data-map-side="right" data-map-kind="enemy" data-map-marker aria-label="Marchfield Coney, The Broken Milestone, Fallowmarch" title="Marchfield Coney, The Broken Milestone, Fallowmarch"><span>Marchfield Coney<small>The Broken Milestone, Fallowmarch</small></span></a>
</div>
