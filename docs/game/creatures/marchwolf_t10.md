---
title: "Tarn Marchwolf"
description: "Tarn Marchwolf spawn locations, combat stats, and drops."
---

<div class="corealm-creature-spawn-evidence">
<div class="corealm-quest-scenes"><figure class="corealm-quest-scene"><img src="/game/assets/captures/enemy-groups/tarn_marchwolves.webp" alt="Tarn Marchwolf at its authored spawn in Karrowmoor" loading="lazy" /><figcaption><strong>Tarn Marchwolf</strong><span>Cairn Tarns, Karrowmoor</span></figcaption></figure></div>
<figure class="corealm-location-map corealm-creature-map" data-location-map style="--map-image-ratio:1.3333333333333333">
<div class="corealm-map-viewport" data-map-viewport role="region" tabindex="0" aria-label="Spawn map for Tarn Marchwolf">
...
<a class="corealm-map-marker" href="../../regions/#cairn-tarns" style="--map-x:69.0000%;--map-y:55.8333%" data-map-side="left" data-map-kind="enemy" data-map-marker aria-label="Tarn Marchwolf, Cairn Tarns, Karrowmoor" title="Tarn Marchwolf, Cairn Tarns, Karrowmoor"><span>Tarn Marchwolf<small>Cairn Tarns, Karrowmoor</small></span></a>
</div>
...
| --- | --- | --- | --- |
| [Karrowmoor](../../regions/#cairn-tarns) | [Cairn Tarns](../../regions/#cairn-tarns) | Tarn Marchwolf | 4 |

## Stats

| Tier | Health | Attack | Defence | Accuracy | Max hit | Attack speed | Armour | Magic armour | Behaviour | Aggro |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 10 | 30 | 21 | 12 | 18 | 7 | 1.8 s | 20 | 12 | aggressive | 12 m |
