...
<a class="corealm-map-marker" href="../../regions/#duskoak-stand" style="--map-x:50.8333%;--map-y:34.5000%" data-map-side="right" data-map-kind="enemy" data-map-marker aria-label="Duskoak Stag, Duskoak Stand, Vellenwood" title="Duskoak Stag, Duskoak Stand, Vellenwood"><span>Duskoak Stag<small>Duskoak Stand, Vellenwood</small></span></a>
</div>
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 5 | 26 | 12 | 7 | 12 | 5 | 2.4 s | 10 | 18 | territorial | 9 m |
