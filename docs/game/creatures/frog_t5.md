...
<a class="corealm-map-marker" href="../../regions/#blackwater-pools" style="--map-x:59.3333%;--map-y:42.0000%" data-map-side="right" data-map-kind="enemy" data-map-marker aria-label="Blackwater Frog, Blackwater Pools, Vellenwood" title="Blackwater Frog, Blackwater Pools, Vellenwood"><span>Blackwater Frog<small>Blackwater Pools, Vellenwood</small></span></a>
</div>
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 5 | 12 | 10 | 5 | 6 | 3 | 1.2 s | 8 | 8 | passive | 4 m |
