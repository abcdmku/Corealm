...
<div class="corealm-quest-scenes"><figure class="corealm-quest-scene"><img src="../../assets/captures/enemy-groups/rootheart.webp" alt="The Rootheart at its authored spawn in Vellenwood" loading="lazy" /><figcaption><strong>The Rootheart</strong><span>Ember Edge, Vellenwood</span></figcaption></figure></div>
...
<a class="corealm-map-marker" href="../../regions/#ember-edge" style="--map-x:75.3333%;--map-y:49.5000%" data-map-side="left" data-map-kind="enemy" data-map-marker aria-label="The Rootheart, Ember Edge, Vellenwood" title="The Rootheart, Ember Edge, Vellenwood"><span>The Rootheart<small>Ember Edge, Vellenwood</small></span></a>
</div>
...
| --- | --- | --- | --- |
| [Vellenwood](../../regions/#ember-edge) | [Ember Edge](../../regions/#ember-edge) | The Rootheart | 1 |
