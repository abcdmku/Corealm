...
<a class="corealm-map-marker" href="../../regions/#ember-edge" style="--map-x:75.3333%;--map-y:36.8333%" data-map-side="left" data-map-kind="enemy" data-map-marker aria-label="The Rootheart, Ember Edge, Vellenwood" title="The Rootheart, Ember Edge, Vellenwood"><span>The Rootheart<small>Ember Edge, Vellenwood</small></span></a>
</div>
