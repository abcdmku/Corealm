---
title: "Marchwolf"
description: "Marchwolf spawn locations, combat stats, and drops."
---

<div class="corealm-creature-spawn-evidence">
<div class="corealm-quest-scenes"><figure class="corealm-quest-scene"><img src="/game/assets/captures/enemy-groups/marchwolves_deepwood.webp" alt="Marchwolf at its authored spawn in Vellenwood" loading="lazy" /><figcaption><strong>Marchwolf</strong><span>Duskoak Stand, Vellenwood</span></figcaption></figure></div>
<figure class="corealm-location-map corealm-creature-map" data-location-map style="--map-image-ratio:1.3333333333333333">
<div class="corealm-map-viewport" data-map-viewport role="region" tabindex="0" aria-label="Spawn map for Marchwolf">
...
<a class="corealm-map-marker" href="../../regions/#duskoak-stand" style="--map-x:53.3333%;--map-y:36.5000%" data-map-side="right" data-map-kind="enemy" data-map-marker aria-label="Marchwolf, Duskoak Stand, Vellenwood" title="Marchwolf, Duskoak Stand, Vellenwood"><span>Marchwolf<small>Duskoak Stand, Vellenwood</small></span></a>
</div>
...
| --- | --- | --- | --- |
| [Vellenwood](../../regions/#duskoak-stand) | [Duskoak Stand](../../regions/#duskoak-stand) | Marchwolf | 4 |

## Stats

| Tier | Health | Attack | Defence | Accuracy | Max hit | Attack speed | Armour | Magic armour | Behaviour | Aggro |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 5 | 28 | 13 | 8 | 10 | 6 | 2.4 s | 14 | 8 | aggressive | 10 m |
