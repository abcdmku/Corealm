...
<a class="corealm-map-marker" href="../../regions/#palewood-copse" style="--map-x:23.3333%;--map-y:58.1667%" data-map-side="right" data-map-kind="enemy" data-map-marker aria-label="Palewood Adder, Palewood Copse, Fallowmarch" title="Palewood Adder, Palewood Copse, Fallowmarch"><span>Palewood Adder<small>Palewood Copse, Fallowmarch</small></span></a>
</div>
