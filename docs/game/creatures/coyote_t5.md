...
<a class="corealm-map-marker" href="../../regions/#duskoak-stand" style="--map-x:53.8333%;--map-y:36.8333%" data-map-side="right" data-map-kind="enemy" data-map-marker aria-label="Deepwood Coyote, Duskoak Stand, Vellenwood" title="Deepwood Coyote, Duskoak Stand, Vellenwood"><span>Deepwood Coyote<small>Duskoak Stand, Vellenwood</small></span></a>
</div>
