...
| --- | --- | --- | --- | --- | --- |
| 1 | Palewood | [Palewood Log](./items/#palewood-log) | 1× Palewood Log → 4× Palewood Shaft for 10 XP | 1× Palewood Log → 2× Palewood Handle for 10 XP | [Palewood Staff](./items/#palewood-staff) from 3× Palewood Shaft + 1× Pale Quartz; [Palewood Wand](./items/#palewood-wand) from 1× Palewood Shaft + 1× Pale Quartz; [Palewood Shield](./items/#palewood-shield) from 2× Palewood Log + 1× Grithe Bar; [Quartz Focus](./items/#quartz-focus) from 1× Palewood Log + 1× Pale Quartz; [Palewood Rod](./items/#palewood-rod) from 2× Palewood Shaft + 1× Coarse Hide |
| 5 | Duskoak | [Duskoak Log](./items/#duskoak-log) | 1× Duskoak Log → 4× Duskoak Shaft for 24 XP | 1× Duskoak Log → 2× Duskoak Handle for 24 XP | [Duskoak Staff](./items/#duskoak-staff) from 3× Duskoak Shaft + 1× Vell Amber; [Duskoak Wand](./items/#duskoak-wand) from 1× Duskoak Shaft + 1× Vell Amber; [Duskoak Shield](./items/#duskoak-shield) from 2× Duskoak Log + 1× Corven Bar; [Amber Focus](./items/#amber-focus) from 1× Duskoak Log + 1× Vell Amber; [Duskoak Rod](./items/#duskoak-rod) from 2× Duskoak Shaft + 1× Bramble Hide |
| 10 | Cairnpine | [Cairnpine Log](./items/#cairnpine-log) | 1× Cairnpine Log → 4× Cairnpine Shaft for 35 XP | 1× Cairnpine Log → 2× Cairnpine Handle for 35 XP | [Cairnpine Staff](./items/#cairnpine-staff) from 3× Cairnpine Shaft + 1× Cairn Garnet; [Cairnpine Wand](./items/#cairnpine-wand) from 1× Cairnpine Shaft + 1× Cairn Garnet; [Cairnpine Shield](./items/#cairnpine-shield) from 2× Cairnpine Log + 1× Kaldite Bar; [Garnet Focus](./items/#garnet-focus) from 1× Cairnpine Log + 1× Cairn Garnet; [Cairnpine Rod](./items/#cairnpine-rod) from 2× Cairnpine Shaft + 1× Wight Shroud |

### Mining and Crafting bridge

| Level | Gem | Crafting outputs |
| --- | --- | --- |
| 1 | [Pale Quartz](./items/#pale-quartz) | [Essence Shard](./items/#essence-shard) from 1× Pale Quartz + 1× Palewood Log; [Grithe Ring](./items/#grithe-ring) from 1× Grithe Bar + 1× Pale Quartz; [Grithe Pendant](./items/#grithe-pendant) from 1× Grithe Bar + 1× Pale Quartz; [Ember Ring](./items/#ember-ring) from 1× Grithe Bar + 2× Pale Quartz; [Ember Charm](./items/#ember-charm) from 2× Pale Quartz; [Marchhide Robe](./items/#marchhide-robe) from 3× Coarse Hide; [Marchhide Leggings](./items/#marchhide-leggings) from 2× Coarse Hide; [Marchhide Hood](./items/#marchhide-hood) from 1× Coarse Hide; [Marchhide Boots](./items/#marchhide-boots) from 1× Coarse Hide; [Marchhide Wraps](./items/#marchhide-wraps) from 1× Coarse Hide |
| 5 | [Vell Amber](./items/#vell-amber) | [Essence Shard](./items/#essence-shard) from 1× Vell Amber + 1× Duskoak Log; [Corven Ring](./items/#corven-ring) from 1× Corven Bar + 1× Vell Amber; [Corven Pendant](./items/#corven-pendant) from 1× Corven Bar + 1× Vell Amber; [Stone Ring](./items/#stone-ring) from 1× Corven Bar + 2× Vell Amber; [Stone Charm](./items/#stone-charm) from 2× Vell Amber; [Bramblehide Robe](./items/#bramblehide-robe) from 3× Bramble Hide; [Bramblehide Leggings](./items/#bramblehide-leggings) from 2× Bramble Hide; [Bramblehide Hood](./items/#bramblehide-hood) from 1× Bramble Hide; [Bramblehide Boots](./items/#bramblehide-boots) from 1× Bramble Hide; [Bramblehide Wraps](./items/#bramblehide-wraps) from 1× Bramble Hide |
| 10 | [Cairn Garnet](./items/#cairn-garnet) | [Essence Shard](./items/#essence-shard) from 1× Cairn Garnet + 1× Cairnpine Log; [Kaldite Ring](./items/#kaldite-ring) from 1× Kaldite Bar + 1× Cairn Garnet; [Kaldite Pendant](./items/#kaldite-pendant) from 1× Kaldite Bar + 1× Cairn Garnet; [Storm Ring](./items/#storm-ring) from 1× Kaldite Bar + 2× Cairn Garnet; [Storm Charm](./items/#storm-charm) from 2× Cairn Garnet; [Wightshroud Robe](./items/#wightshroud-robe) from 3× Wight Shroud; [Wightshroud Leggings](./items/#wightshroud-leggings) from 2× Wight Shroud; [Wightshroud Hood](./items/#wightshroud-hood) from 1× Wight Shroud; [Wightshroud Boots](./items/#wightshroud-boots) from 1× Wight Shroud; [Wightshroud Wraps](./items/#wightshroud-wraps) from 1× Wight Shroud |
