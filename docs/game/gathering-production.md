...
| 20 | Emberite Seam | [Emberite Ore](./items/#emberite-ore) | [Fire Opal](./items/#fire-opal) at 7% | 52 | 7-14 | 65 s |
| 20 | Kilnstone Face | [Kilnstone](./items/#kilnstone) | [Fire Opal](./items/#fire-opal) at 3% | 52 | 7-14 | 65 s |
...
| 20 | 3× Emberite Ore + 2× Kilnstone → 1× Emberite Bar | Furnace | 2.4 s | 42 | [Emberite Dagger](./items/#emberite-dagger), [Emberite Sword](./items/#emberite-sword), [Emberite Helm](./items/#emberite-helm), [Emberite Plate](./items/#emberite-plate), [Emberite Greaves](./items/#emberite-greaves), [Emberite Boots](./items/#emberite-boots), [Emberite Gauntlets](./items/#emberite-gauntlets), [Emberite Pickaxe](./items/#emberite-pickaxe), [Emberite Hatchet](./items/#emberite-hatchet) |
...
| 20 | Ashfin Spring | [Ashfin](./items/#ashfin) | [Seared Ashfin](./items/#seared-ashfin) | 19 | 78 | Range / Campfire | 2.4 s | 45% | [Burnt Ashfin](./items/#burnt-ashfin) |
...
| 10 | Cairnpine | [Cairnpine Log](./items/#cairnpine-log) | 1× Cairnpine Log → 4× Cairnpine Shaft for 35 XP | 1× Cairnpine Log → 2× Cairnpine Handle for 35 XP | [Cairnpine Staff](./items/#cairnpine-staff) from 3× Cairnpine Shaft; [Cairnpine Wand](./items/#cairnpine-wand) from 2× Cairnpine Shaft; [Cairnpine Shield](./items/#cairnpine-shield) from 2× Cairnpine Log + 1× Kaldite Bar; [Cairnpine Rod](./items/#cairnpine-rod) from 2× Cairnpine Shaft + 1× Cairn Pelt |
| 20 | Cinderpine | [Cinderpine Log](./items/#cinderpine-log) | 1× Cinderpine Log → 4× Cinderpine Shaft for 52 XP | 1× Cinderpine Log → 2× Cinderpine Handle for 52 XP | [Cinderpine Staff](./items/#cinderpine-staff) from 3× Cinderpine Shaft; [Cinderpine Wand](./items/#cinderpine-wand) from 2× Cinderpine Shaft; [Cinderpine Shield](./items/#cinderpine-shield) from 2× Cinderpine Log + 1× Emberite Bar; [Cinderpine Rod](./items/#cinderpine-rod) from 2× Cinderpine Shaft + 1× Charhide |

### Mining and Crafting bridge

| Level | Gem | Crafting outputs |
| --- | --- | --- |
| 1 | [Pale Quartz](./items/#pale-quartz) | [Air Wand](./items/#air-wand) from 1× Palewood Wand; [Air Staff](./items/#air-staff) from 1× Palewood Staff; [Grithe Ring](./items/#grithe-ring) from 1× Grithe Bar + 1× Pale Quartz; [Grithe Pendant](./items/#grithe-pendant) from 1× Grithe Bar + 1× Pale Quartz; [Ember Ring](./items/#ember-ring) from 1× Grithe Bar + 2× Pale Quartz; [Ember Charm](./items/#ember-charm) from 2× Pale Quartz; [Marchhide Robe](./items/#marchhide-robe) from 3× Coarse Hide; [Marchhide Leggings](./items/#marchhide-leggings) from 2× Coarse Hide; [Marchhide Hood](./items/#marchhide-hood) from 1× Coarse Hide; [Marchhide Boots](./items/#marchhide-boots) from 1× Coarse Hide; [Marchhide Wraps](./items/#marchhide-wraps) from 1× Coarse Hide |
| 5 | [Vell Amber](./items/#vell-amber) | [Earth Wand](./items/#earth-wand) from 1× Duskoak Wand; [Earth Staff](./items/#earth-staff) from 1× Duskoak Staff; [Corven Ring](./items/#corven-ring) from 1× Corven Bar + 1× Vell Amber; [Corven Pendant](./items/#corven-pendant) from 1× Corven Bar + 1× Vell Amber; [Stone Ring](./items/#stone-ring) from 1× Corven Bar + 2× Vell Amber; [Stone Charm](./items/#stone-charm) from 2× Vell Amber; [Bramblehide Robe](./items/#bramblehide-robe) from 3× Bramble Hide; [Bramblehide Leggings](./items/#bramblehide-leggings) from 2× Bramble Hide; [Bramblehide Hood](./items/#bramblehide-hood) from 1× Bramble Hide; [Bramblehide Boots](./items/#bramblehide-boots) from 1× Bramble Hide; [Bramblehide Wraps](./items/#bramblehide-wraps) from 1× Bramble Hide |
| 10 | [Cairn Garnet](./items/#cairn-garnet) | [Water Wand](./items/#water-wand) from 1× Cairnpine Wand; [Water Staff](./items/#water-staff) from 1× Cairnpine Staff; [Kaldite Ring](./items/#kaldite-ring) from 1× Kaldite Bar + 1× Cairn Garnet; [Kaldite Pendant](./items/#kaldite-pendant) from 1× Kaldite Bar + 1× Cairn Garnet; [Storm Ring](./items/#storm-ring) from 1× Kaldite Bar + 2× Cairn Garnet; [Storm Charm](./items/#storm-charm) from 2× Cairn Garnet; [Cairnpelt Robe](./items/#cairnpelt-robe) from 3× Cairn Pelt; [Cairnpelt Leggings](./items/#cairnpelt-leggings) from 2× Cairn Pelt; [Cairnpelt Hood](./items/#cairnpelt-hood) from 1× Cairn Pelt; [Cairnpelt Boots](./items/#cairnpelt-boots) from 1× Cairn Pelt; [Cairnpelt Wraps](./items/#cairnpelt-wraps) from 1× Cairn Pelt |
| 20 | [Fire Opal](./items/#fire-opal) | [Fire Wand](./items/#fire-wand) from 1× Cinderpine Wand; [Fire Staff](./items/#fire-staff) from 1× Cinderpine Staff; [Emberite Ring](./items/#emberite-ring) from 1× Emberite Bar + 1× Fire Opal; [Emberite Pendant](./items/#emberite-pendant) from 1× Emberite Bar + 1× Fire Opal; [Cinder Ring](./items/#cinder-ring) from 1× Emberite Bar + 2× Fire Opal; [Cinder Charm](./items/#cinder-charm) from 2× Fire Opal; [Charhide Robe](./items/#charhide-robe) from 3× Charhide; [Charhide Leggings](./items/#charhide-leggings) from 2× Charhide; [Charhide Hood](./items/#charhide-hood) from 1× Charhide; [Charhide Boots](./items/#charhide-boots) from 1× Charhide; [Charhide Wraps](./items/#charhide-wraps) from 1× Charhide |
