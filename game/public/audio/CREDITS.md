...
- Region music — supplied for Corealm by the repository owner; embedded artist tag `phreesplox`.

The complete source paths, hashes, transformations, license evidence, and rejected material are in
the `docs/audio-source-*.md` ledgers at the repository root.
